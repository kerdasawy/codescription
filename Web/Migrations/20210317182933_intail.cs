    ...
    public partial class intail : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "red", "Error in operation or user input invalid.", "Error" },
                    { 2, "yellow", "Warning in operation or user input has issue.", "Warning" },
                    { 3, "gray", "Operation Status and info.", "Status" }
                });
